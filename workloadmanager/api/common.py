...
XML_NS_V1 = 'http://docs.triliodata.com/workloadmanager/api/v1'
...
def limited_by_marker(items, request, max_limit=FLAGS.workloadmanager_max_limit):
...
def remove_version_from_href(href):
    ...
    Given: 'http://www.workloadmanager.com/v1/123'
    Returns: 'http://www.workloadmanager.com/123'

    Given: 'http://www.workloadmanager.com/v1'
    Returns: 'http://www.workloadmanager.com'
...
class ViewBuilder(object):
    ...
    def _get_next_link(self, request, identifier):
        ...
        prefix = self._update_link_prefix(request.application_url,
                                          FLAGS.workloadmanager_base_URL)
        url = os.path.join(prefix,
                           request.environ["workloadmanager.context"].project_id,
