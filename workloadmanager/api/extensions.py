...
class ExtensionManager(object):
    ...
    See workloadmanager/tests/api/extensions/foxinsocks/extension.py for an
    ...
    def _load_extensions(self):
        ...
        contrib_path = 'workloadmanager.api.contrib.standard_extensions'
...
class ControllerExtension(object):
    """Extend core controllers of workloadmanager API.

    Provide a way to extend existing workloadmanager API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the API in workloadmanager."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None):
        ...
        workloadmanager.policy.enforce(context, action, target)
    return authorize
