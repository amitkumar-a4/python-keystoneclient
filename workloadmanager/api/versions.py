...
from workloadmanager.api.views import versions as views_versions
        ...
        "links": [
            {
                ...
                "href": "http://www.triliodata.com/workloadmanager/"
                        "content/workloadmanager-1.0.pdf",
            },
        ],
        "media-types": [
            {
...
class AtomSerializer(wsgi.XMLDictSerializer):
    ...
    def _create_feed(self, versions, feed_title, feed_id):
        ...
        etree.SubElement(author, 'name').text = 'TrilioData'
        etree.SubElement(author, 'uri').text = 'http://www.triliodata.com/'
