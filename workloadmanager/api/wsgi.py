...
from workloadmanager import wsgi
...
XMLNS_V1 = 'http://docs.triliodata.org/workloadmanager/api/v1'
...
_CONTENT_TYPE_MAP = {
    'application/vnd.triliodata.workloadmanager+json': 'application/json',
    'application/vnd.triliodata.workloadmanager+xml': 'application/xml',
}

SUPPORTED_CONTENT_TYPES = (
    'application/json',
    'application/vnd.triliodata.workloadmanager+json',
    'application/xml',
    'application/vnd.triliodata.workloadmanager+xml',
)

_MEDIA_TYPE_MAP = {
    'application/vnd.triliodata.workloadmanager+json': 'json',
    'application/json': 'json',
    'application/vnd.triliodata.workloadmanager+xml': 'xml',
    'application/xml': 'xml',
...
class Request(webob.Request):
    """Add some workloadmanager API-specific logic to the base webob.Request."""

    def best_match_content_type(self):
        """Determine the requested response content-type."""
        if 'workloadmanager.best_content_type' not in self.environ:
            ...
            self.environ['workloadmanager.best_content_type'] = (content_type or
                                                        'application/json')

        return self.environ['workloadmanager.best_content_type']
...
class Resource(wsgi.Application):
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('workloadmanager.context')
...
def _set_request_id_header(req, headers):
    context = req.environ.get('workloadmanager.context')
    if context:
