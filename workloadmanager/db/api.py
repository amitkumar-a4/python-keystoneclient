...
Functions in this module are imported into the workloadmanager.db namespace. Call these
functions from workloadmanager.db namespace, not the workloadmanager.db.api namespace.
...
:sql_connection:  string specifying the sqlalchemy connection to use, like:
                  `sqlite:///var/lib/workloadmanager/workloadmanager.sqlite`.
...
IMPL = utils.LazyPluggable('db_backend',
                           sqlalchemy='workloadmanager.db.sqlalchemy.api')


class NoMoreTargets(exception.WorkloadManagerException):
