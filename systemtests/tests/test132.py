...
class test132(WorkloadMgrSystemTest):
    ...
    def run(self, *args, **kwargs):
        ...
        self._testshell.cs.workloads.snapshot(self.workload.id, name="Full snapshot", description="First snapshot of the workload")
        ...
        self._testshell.cs.snapshots.restore(self.snapshot.id, name="Restore", description="Restore from full snapshot")
