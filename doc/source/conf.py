# -*- coding: utf-8 -*-
#
# workloadmgr documentation build configuration file, created by
...
if not os.getenv('SPHINX_DEBUG'):
    extensions += ['ext.workloadmgr_autodoc']
...
# built documents.
#
from workloadmgr.version import version_info
...
modindex_common_prefix = ['workloadmgr.']
...
htmlhelp_basename = 'workloadmgrdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'WorkloadMgr.tex', u'WorkloadMgr Documentation',
