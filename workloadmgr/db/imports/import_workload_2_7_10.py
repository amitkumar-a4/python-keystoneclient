...
from workloadmgr.db.imports import import_workload_2_7_9
...
def import_settings(cntx, new_version, upgrade=True):
    return import_workload_2_7_9.import_settings(cntx, new_version, upgrade)


def import_workload(cntx, workload_ids, new_version, upgrade=True):
    """ Import workload and snapshot records from vault
        Versions Supported: 2.7.10
    """
    return import_workload_2_7_9.import_workload(
