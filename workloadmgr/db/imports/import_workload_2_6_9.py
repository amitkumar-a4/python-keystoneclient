...
from workloadmgr.db.imports import import_workload_2_6_8
...
def import_settings(cntx, new_version, upgrade=True):
    return import_workload_2_6_8.import_settings(cntx, new_version, upgrade)
...
def import_workload(cntx, workload_ids, new_version, upgrade=True):
    ...
    """
    return import_workload_2_6_8.import_workload(
