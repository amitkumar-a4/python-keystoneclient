...
from workloadmgr.db.imports import import_workload_2_1_114
...
def import_settings(cntx, new_version, upgrade=True):
    ...
    return import_workload_2_1_114.import_settings(cntx, new_version)
...
def import_workload(cntx, workload_url, new_version, upgrade=True):
    ...
    """
    return import_workload_2_1_114.import_workload(cntx, workload_url, new_version, upgrade)
