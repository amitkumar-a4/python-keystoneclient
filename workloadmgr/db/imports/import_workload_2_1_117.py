...
from workloadmgr.db.imports import import_workload_2_1_116
...
def import_settings(cntx, new_version, upgrade=True):
    ...
    return import_workload_2_1_116.import_settings(cntx, new_version)

def import_workload(cntx, workload_url, new_version, upgrade=True):
    """ Import workload and snapshot records from vault 
    Versions Supported: 2.1.117
    """
    return import_workload_2_1_116.import_workload(cntx, workload_url, new_version, upgrade)
