...
from workloadmgr.db.imports import import_workload_2_6_20
...
def import_settings(cntx, new_version, upgrade=True):
    return import_workload_2_6_20.import_settings(cntx, new_version, upgrade)


def import_workload(cntx, workload_ids, new_version, upgrade=True):
    """ Import workload and snapshot records from vault
        Versions Supported: 2.6.21
    """
    return import_workload_2_6_20.import_workload(
