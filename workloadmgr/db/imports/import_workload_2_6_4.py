...
from workloadmgr.db.imports import import_workload_2_6_3
...
def import_settings(cntx, new_version, upgrade=True):
    return import_workload_2_6_3.import_settings(cntx, new_version, upgrade)


def import_workload(cntx, workload_ids, new_version, upgrade=True):
    """ Import workload and snapshot records from vault
        Versions Supported: 2.6.4
    """
    return import_workload_2_6_3.import_workload(
