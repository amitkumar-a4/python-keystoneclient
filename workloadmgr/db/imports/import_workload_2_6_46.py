...
from workloadmgr.db.imports import import_workload_2_6_45
...
def import_settings(cntx, new_version, upgrade=True):
    return import_workload_2_6_45.import_settings(cntx, new_version, upgrade)


def import_workload(cntx, workload_ids, new_version, upgrade=True):
    """ Import workload and snapshot records from vault
        Versions Supported: 2.6.46
    """
    return import_workload_2_6_45.import_workload(
