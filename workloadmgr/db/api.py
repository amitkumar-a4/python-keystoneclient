...
Call these functions from workloadmgr.db namespace, not the
workloadmgr.db.api namespace.
...
def snapshot_get_metadata_cancel_flag(context, snapshot_id, return_val=0,
                                      process=None, **kwargs):
...
def snapshot_get_all_by_project_workload(context, project_id,
                                         workload_id, **kwargs):
    """Get all snapshots belonging to a project and workload"""
    return IMPL.snapshot_get_all_by_project_workload(context, project_id,
                                                     workload_id, **kwargs)
...
def snapshot_vm_resource_update(context, id, vaules, purge_metadata=False):
    return IMPL.snapshot_vm_resource_update(context, id,
                                            vaules, purge_metadata)
...
def snapshot_vm_resource_get_by_resource_pit_id(context, vm_id, snapshot_id,
                                                resource_pit_id):
    return IMPL.snapshot_vm_resource_get_by_resource_pit_id(
        context, vm_id, snapshot_id, resource_pit_id)


def snapshot_vm_resource_get_by_resource_name(context, vm_id, snapshot_id,
                                              resource_name):
...
def vm_disk_resource_snap_update(context, id, vaules, purge_metadata=False):
    return IMPL.vm_disk_resource_snap_update(context, id, vaules,
                                             purge_metadata)
...
def vm_disk_resource_snap_get_snapshot_vm_resource_id(context,
                                                      vm_disk_resource_snap_id):  # nopep8
...
def vm_network_resource_snap_update(context, id, vaules, purge_metadata=False):
    return IMPL.vm_network_resource_snap_update(context, id, vaules,
                                                purge_metadata)
...
def vm_network_resource_snap_delete(context, vm_network_resource_snap_id):
    return IMPL.vm_network_resource_snap_delete(context,
...
def vm_security_group_rule_snap_update(context, id, vm_security_group_snap_id,
                                       vaules, purge_metadata=False):
    return IMPL.vm_security_group_rule_snap_update(context, id,
...
def vm_security_group_rule_snaps_get(context, vm_security_group_snap_id,
                                     **kwargs):
    return IMPL.vm_security_group_rule_snaps_get(context,
                                                 vm_security_group_snap_id,
                                                 **kwargs)


def vm_security_group_rule_snap_get(context, id, vm_security_group_snap_id):
    return IMPL.vm_security_group_rule_snap_get(context, id,
                                                vm_security_group_snap_id)


def vm_security_group_rule_snap_delete(context, id,
...
def restore_get_metadata_cancel_flag(context, restore_id, return_val=0,
                                     process=None, **kwargs):
...
def restore_get_all_by_project_snapshot(context, project_id,
                                        snapshot_id, **kwargs):
    """Get all restores belonging to a project and snapshot"""
    return IMPL.restore_get_all_by_project_snapshot(context, project_id,
                                                    snapshot_id, **kwargs)
...
def restored_vm_resource_update(context, restored_vm_resource_id, values,
                                purge_metadata=False):
    return IMPL.restored_vm_resource_update(context, restored_vm_resource_id,
                                            values, purge_metadata)
...
def restored_vm_resource_get_by_resource_name(context, vm_id, restore_id,
                                              resource_name):
    return IMPL.restored_vm_resource_get_by_resource_name(context, vm_id,
                                                          restore_id,
                                                          resource_name)
...
def vault_storage_get_all_by_workload(context, workload_id, **kwargs):
    ...
    return IMPL.vault_storage_get_all_by_workload(context, workload_id,
                                                  **kwargs)
