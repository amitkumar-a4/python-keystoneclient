...
CREATE TABLE `setting_metadata` (
  ...
  KEY `settings_project_id` (`settings_project_id`),
  KEY `ix_setting_metadata_settings_name` (`settings_name`),
  CONSTRAINT `setting_metadata_ibfk_1` FOREIGN KEY (`settings_name`) REFERENCES `settings` (`name`),
  CONSTRAINT `setting_metadata_ibfk_2` FOREIGN KEY (`settings_project_id`) REFERENCES `settings` (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-29 11:58:30
