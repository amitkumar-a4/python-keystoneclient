...
import workloadmgr.exception
import workloadmgr.flags as flags
...
def get_session(autocommit=True, expire_on_commit=False):
    ...
    session = _MAKER()
    session.query = workloadmgr.exception.wrap_db_error(session.query)
    session.flush = workloadmgr.exception.wrap_db_error(session.flush)
    return session
