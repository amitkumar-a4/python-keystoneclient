...
def upgrade(migrate_engine):
    ...
    snapshot_vm_resource_metadata = Table(
        ...
        Column('version', String(length=255)),
        Column('id', String(length=255), primary_key=True, nullable=False),
        Column('snapshot_vm_resource_id', String(length=255), ForeignKey(
            'snapshot_vm_resources.id'), nullable=False, index=True),
        Column('key', String(255), nullable=False),
        Column('value', Text()),
    ...
    vm_disk_resource_snaps = Table(
        ...
        Column('version', String(length=255)),
        Column('id', String(length=255), primary_key=True, nullable=False),
        Column('snapshot_vm_resource_id', String(length=255),
    ...
    vm_disk_resource_snap_metadata = Table(
        ...
        Column('version', String(length=255)),
        Column('id', String(length=255), primary_key=True, nullable=False),
        Column('vm_disk_resource_snap_id', String(length=255), ForeignKey(
            'vm_disk_resource_snaps.id'), nullable=False, index=True),
        Column('key', String(255), nullable=False),
        Column('value', Text()),
    ...
    vm_network_resource_snaps = Table(
        ...
        Column('deleted', Boolean),
        Column('version', String(length=255)),
        Column('vm_network_resource_snap_id', String(length=255),
               ForeignKey('snapshot_vm_resources.id'), primary_key=True),
    ...
    vm_security_group_rule_snap_metadata = Table(
        ...
        Column('version', String(length=255)),
        Column('id', String(length=255), primary_key=True, nullable=False),
        Column('vm_security_group_rule_snap_id', String(length=255), ForeignKey(
            'vm_security_group_rule_snaps.id'), nullable=False, index=True),
        Column('key', String(255), nullable=False),
        Column('value', Text()),
    ...
    restored_vm_resource_metadata = Table(
        ...
        Column('version', String(length=255)),
        Column('id', String(length=255), primary_key=True, nullable=False),
        Column('restored_vm_resource_id', String(length=255), ForeignKey(
            'restored_vm_resources.id'), nullable=False, index=True),
        Column('key', String(255), nullable=False),
        Column('value', Text()),
    ...
    setting_metadata = Table(
        ...
        Column(
            ...
            String(
                length=255),
            ForeignKey('settings.project_id'),
            nullable=False),
        Column('key', String(255), nullable=False),
        Column('value', Text()),
...
def downgrade(migrate_engine):
    LOG.exception(
        _('Downgrade from initial WorkloadMgr install is unsupported.'))
