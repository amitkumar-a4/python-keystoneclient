...
from workloadmgr.db.sqlalchemy.session import get_engine
...
# TODO(gbasava) When migrate 0.7.3 is released and workloadmgr depends
...
# NOTE(giri) Delay importing migrate until we are patched
...
def db_version():
    ...
    try:
        ...
        if len(tables) == 0:
            ...
            raise exception.Error(_("Upgrade DB using v1.0 release first."))
