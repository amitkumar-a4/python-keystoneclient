...
service_opts = [
    ...
    cfg.StrOpt('workloadmgr_service_listen',
               default="0.0.0.0",
               help='IP address for Oworkloadmgr API to listen'),
    cfg.IntOpt('workloadmgr_service_listen_port',
               default=8780,
               help='port for workloadmgr api to listen'), ]
...
class Service(object):
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        :param topic: defaults to bin_name - 'workloadmgr-' part
        ...
        if not topic:
            topic = binary
        if not manager:
            subtopic = topic.rpartition('workloadmgr-')[2]
