...
class ExtensionManager(object):
    ...
    See workloadmgr/tests/api/extensions/foxinsocks/extension.py for an
    ...
    def __init__(self):
        ...
        self.cls_list = FLAGS.osapi_workloadmgr_extension
        self.extensions = {}
    ...
    def _load_extensions(self):
        ...
        contrib_path = 'workloadmgr.api.contrib.standard_extensions'
...
class ControllerExtension(object):
    """Extend core controllers of workloadmgr API.

    Provide a way to extend existing workloadmgr API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the API in workloadmgr."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None):
        ...
        workloadmgr.policy.enforce(context, action, target)
    return authorize
