...
class APIRouter(workloadmgr.api.APIRouter):
    ...
    def _setup_routes(self, mapper, ext_mgr):
        ...
        #######################################################################
        self.resources['workload_types'] = workloadtypes.create_resource(
            ext_mgr)
        ...
        # workload license
        mapper.connect("workloads_license_check",
                       "/{project_id}/workloads/metrics/license_check",
                       controller=self.resources['workloads'],
        ...
        #######################################################################
        self.resources['global_job_scheduler'] = global_job_scheduler.create_resource(
            ext_mgr)
        ...
        #######################################################################
        # Config workload
        self.resources['config_workload'] = config_workload.create_resource(
            ext_mgr)
        ...
        #######################################################################
        # Config backup
        self.resources['config_backup'] = config_backup.create_resource(
            ext_mgr)
