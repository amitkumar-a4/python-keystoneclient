...
XMLNS_V1 = 'http://docs.triliodata.org/workloadmgr/api/v1'
...
_CONTENT_TYPE_MAP = {
    'application/vnd.triliodata.workloadmgr+json': 'application/json',
    'application/vnd.triliodata.workloadmgr+xml': 'application/xml',
}

SUPPORTED_CONTENT_TYPES = (
    'application/json',
    'application/vnd.triliodata.workloadmgr+json',
    'application/xml',
    'application/vnd.triliodata.workloadmgr+xml',
)

_MEDIA_TYPE_MAP = {
    'application/vnd.triliodata.workloadmgr+json': 'json',
    'application/json': 'json',
    'application/vnd.triliodata.workloadmgr+xml': 'xml',
    'application/xml': 'xml',
...
class Request(webob.Request):
    """Add some workloadmgr API-specific logic to the base webob.Request."""
