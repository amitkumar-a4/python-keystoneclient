...
global_opts = [
    ...
    cfg.StrOpt('workloadmgr_base_URL',
               default=None,
               help='Base URL that will be presented to users in links '
                    'to the workloadmgr API'),
    cfg.IntOpt('workloadmgr_max_limit',
               default=1000,
    ...
    cfg.StrOpt('workloads_manager',
               default='workloadmgr.workloads.manager.WorkloadMgr',
               help='full class name for the Manager for workloads'),
