...
def install_dependencies(venv=VENV):
    ...
    # Tell the virtual env how to "import workloadmgr"
    pthfile = os.path.join(venv, "lib", PY_VERSION, "site-packages",
                        "workloadmgrclient.pth")
    f = open(pthfile, 'w')
    f.write("%s\n" % ROOT)
...
def print_help():
    help = """
    WorkloadMgr development environment setup is complete.

    WorkloadMgr development uses virtualenv to track and manage Python
    dependencies while in development and testing.

    To activate the WorkloadMgr virtualenv for the extent of your
