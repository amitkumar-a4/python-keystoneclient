...
ignore_messages = [
    ...
    # ignored for workloadmgr.tests modules
    "An attribute affected in workloadmgr.tests",
...
# Note(maoy):  We ignore workloadmgr.tests for now due to high false
# positive rate.
ignore_modules = ["workloadmgr/tests/"]

# Note(thangp): E0213, E1101, and E1102 should be ignored for only
# workloadmgr.object modules. E0213 and E1102 are error codes related to
...
# the workloadmgr code base using objects. E1120 is an error code related no value
...
objects_ignore_modules = ["workloadmgr/objects/"]
...
def run_pylint():
    ...
    args = ["--include-ids=y", "-E", "workloadmgr"]
